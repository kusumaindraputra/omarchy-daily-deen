...
var STRINGS = {
  en: {
    ...
    showArabic: "Show the Arabic", showAyah: "Show an ayah", showHadith: "Show a hadith",
    search: "Search",
  ...
  id: {
    ...
    showArabic: "Tampilkan teks Arab", showAyah: "Tampilkan ayat", showHadith: "Tampilkan hadis",
    search: "Cari",
  ...
  ms: {
    ...
    showArabic: "Papar teks Arab", showAyah: "Papar ayat", showHadith: "Papar hadis",
    search: "Cari",
  ...
  ar: {
    ...
    showArabic: "اعرض النص العربي", showAyah: "اعرض آية", showHadith: "اعرض حديثًا",
    search: "بحث",
  ...
  tr: {
    ...
    showArabic: "Arapça metni göster", showAyah: "Ayet göster", showHadith: "Hadis göster",
    search: "Ara",
  ...
  ur: {
    ...
    showArabic: "عربی متن دکھائیں", showAyah: "آیت دکھائیں", showHadith: "حدیث دکھائیں",
    search: "تلاش",
  ...
  bn: {
    ...
    showArabic: "আরবি লেখা দেখান", showAyah: "আয়াত দেখান", showHadith: "হাদিস দেখান",
    search: "খুঁজুন",
  ...
  fr: {
    ...
    showArabic: "Afficher l'arabe", showAyah: "Afficher un verset", showHadith: "Afficher un hadith",
    search: "Rechercher",
  ...
  ru: {
    ...
    showArabic: "Показывать арабский", showAyah: "Показывать аят", showHadith: "Показывать хадис",
    search: "Поиск",
